...
- docs/API_SPEC.md — REST contract; source of truth over any Bruno collection
...
- A change to docs/API_SPEC.md that adds or changes an endpoint must be matched by a `bruno/` update in the same change, once that directory exists.
